...
//			}
			try {
				ContainerReference eteil12 = capi.lookupContainer("Einzelteile", new URI("xvsm://localhost:9876"),RequestTimeout.DEFAULT, null);
				capi.write(eteil12, new Entry(teil));
			} catch (Exception e) {
				System.err.println("Problem starting or writing in the Space!");
				e.printStackTrace();
			}
